"""  
https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-90Ar1.pdf#page=56
"""

import os
from typing import Optional
from Crypto.Cipher import AES
from ml_dsa.utilities.utils import xor_bytes
...
class AES_CTR_DRBG:
    ...
    def random_seed(self, num_bytes: int, additional: Optional[bytes] = None):
        """
        The NIST recommends an "extended AES-CTR-DRBG interface" for its Post-Quantum Cryptography Project submissions.
        This interface allows multiple sets of randomness to be generated without intervening erasure.
        ...
        https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-90Ar1.pdf#page=56
        We are only implementing the random bytes generation.
        """
